...
// Markdown controller factory function
func Markdown() (string, *MarkdownController) {
	return "markdown", &MarkdownController{}
}

// MarkdownController handles markdown rendering
type MarkdownController struct {
	application.BaseController
}

// Setup registers routes (none needed for markdown rendering)
func (c *MarkdownController) Setup(app *application.App) {
	c.BaseController.Setup(app)
	// No routes needed - this controller only provides helper methods for templates
}
...
func (c *MarkdownController) RenderMarkdown(content string) template.HTML {
