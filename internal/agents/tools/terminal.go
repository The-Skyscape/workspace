...
func (t *RunCommandTool) ValidateParams(params map[string]interface{}) error {
...
func (t *RunCommandTool) Execute(params map[string]interface{}, userID string) (string, error) {
...
func (t *GetWorkingDirectoryTool) ValidateParams(params map[string]interface{}) error {
...
func (t *GetWorkingDirectoryTool) Schema() map[string]interface{} {
	return SimpleSchema(map[string]interface{}{
		"repo_id": map[string]interface{}{
			"type":        "string",
...
func (t *GetWorkingDirectoryTool) Execute(params map[string]interface{}, userID string) (string, error) {
...
func (t *InstallPackageTool) ValidateParams(params map[string]interface{}) error {
...
func (t *InstallPackageTool) Schema() map[string]interface{} {
	return SimpleSchema(map[string]interface{}{
...
func (t *InstallPackageTool) Execute(params map[string]interface{}, userID string) (string, error) {
	// Get user to check permissions
	user, err := models.Auth.GetUser(userID)
	if err != nil {
		return "", fmt.Errorf("failed to get user: %w", err)
	...
	result, err := runCmd.Execute(map[string]interface{}{
		"command":         command,
...
func (t *ListProcessesTool) ValidateParams(params map[string]interface{}) error {
	return nil
}

func (t *ListProcessesTool) Schema() map[string]interface{} {
	return SimpleSchema(map[string]interface{}{
...
func (t *ListProcessesTool) Execute(params map[string]interface{}, userID string) (string, error) {
	// Get user to check permissions
	user, err := models.Auth.GetUser(userID)
	if err != nil {
		return "", fmt.Errorf("failed to get user: %w", err)
